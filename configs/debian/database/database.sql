...
CREATE TABLE IF NOT EXISTS `domain` (
  ...
  `phpini_perm_log_errors` VARCHAR( 20 ) NOT NULL DEFAULT 'no',
...
CREATE TABLE IF NOT EXISTS `php_ini` (
  ...
  `log_errors` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'off',
...
CREATE TABLE IF NOT EXISTS `reseller_props` (
  ...
  `php_ini_al_log_errors` VARCHAR(15) NOT NULL DEFAULT 'no',
